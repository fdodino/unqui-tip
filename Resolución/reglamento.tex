...
\nuevo{separa la reglamentacion de las modalidades tradicionales y la nueva
modalidad}
...
\nuevo{se agrupa en un capítulo todos los antoguos capítulos que hacen
...
\end{enumerate}
\nota{eliminar la antiguedad requerida?}
...
\cambio{Antes se llamaba PRESENTACION DEL INFORME}
...
\cambio{Antes se pedia un formato escrito en esta instancia}
...
\cambio{Se entrega todo el material electronico para la evaluacion}
...
quedaba en el dictámen, si no en las actas de alumnos.}
...
mérito equivalente.
\nota{quedó bien esto? nótese que para este cargo no se exige antiguedad como
...
\nota{hace falta poner los requisits para ser consultor? y las resupongo que no,
